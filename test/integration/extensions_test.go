...
encryption:
  ...
  extensions:
    custom_extension:
      critical: false
      # Missing oid and value encoding fields
encryption:
  provider: "password"`,
			hostsConfig: `hosts: {}`,
			expectedErr: "missing property 'oid'",
		},
	}
...
func createComprehensiveCAConfig(path string) error {
  ...
  extensions:
    ...
    custom_ca_extension:
      ...
      base64: "Q29tcHJlaGVuc2l2ZSBDQSBUZXN0"
  ...
  test-server:
    ...
    extensions:
      ...
      custom_host_extension:
        ...
        base64: "SG9zdCBTcGVjaWZpYyBEYXRh"
...
func createAllExtensionsCAConfig(path string) error {
  ...
  extensions:
    ...
    cert_policies_extension:
      critical: false
      oid: "2.5.29.32"
      hex: "30123010060A2B060104018237140202020204deadbeef"
    ...
    ms_template_info_extension:
      ...
      hex: "30160608608060020201010201020101"
    ...
    subject_dir_attrs_extension:
      critical: false
      oid: "2.5.29.9"
      hex: "30123010060355040306090c074578616d706c65"
  ...
  comprehensive-host:
    ...
    extensions:
      ...
      subject_info_access_extension:
        ...
        asn1:
          string: "http://sia.extensions-test.local"
      ...
      ms_app_policies_extension:
        ...
        hex: "30123010060855040306090c074578616d706c65"
      ...
      netscape_base_url_extension:
        ...
        asn1:
          string: "https://comprehensive-host.extensions-test.local/"
      ...
      netscape_revocation_url_extension:
        ...
        asn1:
          string: "https://crl.extensions-test.local/revocation"
      ...
      netscape_ca_revocation_url_extension:
        ...
        asn1:
          string: "https://crl.extensions-test.local/ca-revocation"
      ...
      netscape_ssl_server_name_extension:
        ...
        asn1:
          string: "comprehensive-host.extensions-test.local"
